# QBIT NOVA C — v1.0 State-Vector Core

Status: historical milestone branch.

## Branch scope

Adds the standalone two-qbit state-vector core and its focused test.

- Branch: `v1.0-state-vector-core`
- Inspected tip: `4dd0d438d458`
...
```bash
git switch v1.0-state-vector-core
git log -1 --oneline
